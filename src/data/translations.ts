  ...
  pt: {
    ...
    schedule: {
      ...
      items: {
        ...
        closing: "Quasar: Encerramento e Próximos Passos"
      }
    },
    location: {
    ...
    registration: {
      title: "Inscrição",
      description: "Registre seu interesse em participar do II Encontro Quasar.",
    ...
    footer: {
      support: "Apoio",
      organizedBy: "Realização",
      rights: "© 2026 II Encontro Quasar. Todos os direitos reservados."
    }
  },
  en: {
    nav: {
